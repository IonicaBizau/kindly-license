...
I'm not a supporter of closed source software. I do not promote it.
This license contains simple and human readable terms. It lets the
author to decide if he/she allows using their work in closed source
...
In the `i18n` directory you can find the license translated in other languages. If your
